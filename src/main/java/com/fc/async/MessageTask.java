...
public class MessageTask implements Runnable {
    ...
    public MessageTask(MessageMapper messageMapper, UserMapper userMapper,int uid, int sessionUid, int operation) {
        this.messageMapper = messageMapper;
        this.userMapper = userMapper;
        this.uid = uid;
        this.sessionUid = sessionUid;
    ...
    public void run() {
        ...
        if (operation==MyConstant.OPERATION_FOLLOW){
            //设置是谁的消息
            message.setUid(uid);
            ...
            message.setOperation(message.getOtherUsername()+"请求加您为好友:");
